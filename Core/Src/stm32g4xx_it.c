...
extern  uint8_t	flag_step_power;
extern uint32_t real_tic_zamer_tim8_1; // реальный замер - количество тиков на тим8 - в пропорции к импульсу накачки
extern uint32_t real_tic_zamer_tim8_2; // реальный замер - количество тиков на тим8 - в пропорции к импульсу накачки
extern uint32_t real_tic_zamer_tim8_3; // реальный замер - количество тиков на тим8 - в пропорции к импульсу накачки
